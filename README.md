...
Đã thực hiện tối thiểu 10 commit có ý nghĩa trong quá trình phát triển dự án.
...
Đã tạo và sử dụng nhiều branch để phát triển tính năng độc lập.
...
Đã tạo Pull Request để hợp nhất mã nguồn từ các branch tính năng vào branch chính.
...
Bài thực hành đã được hoàn thành đầy đủ theo yêu cầu. Các tiêu chí về repository, commit, branch, pull request, merge conflict và revert đều được thực hiện thành công. Qua bài thực hành, tôi đã nâng cao kỹ năng sử dụng Git và GitHub trong quản lý và phát triển phần mềm.
